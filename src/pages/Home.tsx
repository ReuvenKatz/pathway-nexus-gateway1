          ...
          <div className="text-center">
            <div className="relative -mx-4 sm:-mx-6 lg:-mx-8 mb-8">
              <div
                ...
                style={{
                  backgroundImage: 'url(/lovable-uploads/a3006bd5-b515-4ab7-a8b0-39fb481d75ef.png)',
            ...
            <div className="flex flex-col lg:flex-row gap-8 max-w-7xl mx-auto text-left">
              ...
              <div className="flex flex-col items-start lg:w-2/5">
                <p className="text-xl lg:text-2xl text-gray-700 leading-relaxed mb-4 max-w-[322px]">
